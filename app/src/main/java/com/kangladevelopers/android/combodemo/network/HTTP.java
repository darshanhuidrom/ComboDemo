package com.kangladevelopers.android.combodemo.network;
...
import com.kangladevelopers.android.combodemo.utility.LogMessage;
...
public class HTTP {
    ...
    public static String fetchDataFromUrl(int method, String dataUrl, HashMap<String, String> params) {
        ...
        try {
            ...
            LogMessage.showLogMessage(TAG, ">>>>>> Url: " + url);
            if (status == SUCCESS) {
                ...
                LogMessage.showLogMessage(TAG, ">>>>>>ResponseCode:" + urlConnection.getResponseCode());
            } else {
                LogMessage.showLogMessage(TAG, ">>>>>>ResponseCode:" + urlConnection.getResponseCode());
                handleErrorMessage(status);
            }
            LogMessage.showLogMessage(TAG, ">>>>>>" + "Response: " + builder.toString());
    ...
    public static String sendGET(String url) {
        ...
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) { // success
                ...
                LogMessage.showLogMessage(TAG, ">>>>>> data: " + rData);
    ...
    public static String getBasicAuthentication() {
        ...
        String username = AppPreference.getDataFromAppPreference(MyApplication.getAppContext(), Constant.USER_NAME);
        String password = AppPreference.getDataFromAppPreference(MyApplication.getAppContext(), Constant.PASSWORD);
